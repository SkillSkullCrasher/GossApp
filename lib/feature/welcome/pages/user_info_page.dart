...
import 'package:gosapp/common/utils/widgets/custom_elevated_button.dart';
import 'package:gosapp/common/utils/widgets/custom_icon_button.dart';
import 'package:gosapp/common/utils/widgets/short_h_bar.dart';
...
import 'package:gosapp/feature/welcome/pages/image_picker_page.dart';
...
class _UserInfoPageState extends ConsumerState<UserInfoPage> {
  ...
  saveUserDataToFirebase() {
    ...
    if (username.isEmpty) {
      ...
      return showAlertDialog(
          context: context, message: 'A username length should between 3-20');
    }
    ref.read(AuthControllerProvider).saveUserInfoToFirestore(
        username: username,
        profileImage:
            imagCamera ?? imageGallery ?? widget.profileImageUrl ?? '',
        context: context,
        mounted: mounted);
  }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
          ...
          GestureDetector(
            ...
            child: Container(
                ...
                decoration: BoxDecoration(
                  ...
                  border: Border.all(
                      color: imagCamera == null && imageGallery == null
                          ? Colors.transparent
                          : context.theme.greyColor!.withOpacity(0.4)),
                  image: imagCamera != null ||
                          imageGallery != null ||
                      ...
                      ? DecorationImage(
                          ...
                          image: imageGallery != null
                              ...
                              : widget.profileImageUrl != null
                                  ...
                                  : FileImage(imagCamera!) as ImageProvider,
                        )
                      : null,
                ),
                child: Padding(
      ...
      floatingActionButton: CustomElevatedButton(
          onPressed: saveUserDataToFirebase, text: 'NEXT', buttonWidth: 90),
    );
  }
}
